...
<?= $this->section('title') ?>Pasantías<?= $this->endSection() ?>
        ...
        <form method="post" action="<?= site_url('records/preview') ?>" data-record-type="<?= esc($slug) ?>">
            ...
            <div class="mt-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="fecha-inicio" id="fechaInicio"
                        value="<?= old('fecha-inicio') ?>">
                </div>

                <div class="mb-3">
                    <label for="fecha-fin" class="form-label fw-bold">Fecha de finalización</label>
                    <input type="date" class="form-control" name="fecha-fin" id="fechaFin"
                        value="<?= old('fecha-fin') ?>">
                </div>
