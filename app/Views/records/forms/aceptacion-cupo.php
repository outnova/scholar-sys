...
<?= $this->section('title') ?>Aceptación de Cupo<?= $this->endSection() ?>
...
<div class="container mt-4">
    <div class="w-100 w-sm-75 w-md-50 mx-auto">
        ...
        <form method="post" action="<?= site_url('records/preview') ?>" data-record-type="<?= esc($slug) ?>">
            ...
            <div class="mt-4">
                <h3>Constancia de Aceptación de Cupo</h3>
                ...
                <div class="mb-3">
                    <label for="grado" class="form-label fw-bold">Sala / Grado / Año a cursar:</label>
                    <input type="text" class="form-control" name="grado" id="grado" placeholder="Ej: 5to grado, 5to año, Sala de 3 años..."
                        value="<?= old('grado') ?>">
                </div>

                <div class="mb-3">
                    <label for="periodo_escolar" class="form-label fw-bold">Periodo escolar a cursar:</label>
