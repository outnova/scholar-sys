...
<p class="paragraph">
    ...
    hasta la presente fecha; devengando una remuneración mensual de <span class="money">Bs. <?= esc($data['sueldo_mensual']) ?></span> de acuerdo al recibo de pago emanado por la Oficina de Gestión Humana del Ministerio del Poder Popular para la Educación.
</p>
<p class="paragraph">
